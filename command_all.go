...
func (c *WipeAllCommand) Run(args []string) int {

	c.deleteDescriptions = []ResourceDeleteDescription{
...
func (c *WipeAllCommand) Help() string {
	helpText := `
...
func (c *WipeAllCommand) Synopsis() string {
	return "Delete all or one specific resource type"
}

func (c *WipeAllCommand) deleteKmsAliases(resourceType ResourceDeleteDescription) {
